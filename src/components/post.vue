    ...
    <article class="post post-list">
        <div class="post-entry">
            ...
            <h1 class="entry-title">
                <router-link :to="`article/${post.articleId}`"><span v-if="post.isTop"
                                                                     style="color:#ff6d6d;font-weight:600">[置顶] </span>{{post.articleTitle}}
                </router-link>
            </h1>
            <div class="p-time">
            ...
            <footer class="entry-footer">
                <div class="post-more">
                    <router-link :to="`article/${post.articleId}`"><i class="iconfont iconfish-li"
